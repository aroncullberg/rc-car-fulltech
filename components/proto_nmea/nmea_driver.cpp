    ...
    void NmeaDriver::run() {
        ...
        while (running_) {
            ...
            if (gps_.speed.isUpdated()) {
                ...
                speed.speed_mmps = static_cast<int32_t>(gps_.speed.mph() * 1000);
                speed.speed_kmph = static_cast<int32_t>(gps_.speed.kmph());
            ...
            if (gps_.altitude.isUpdated()) {
                altitude.altitude_m = static_cast<int32_t>(gps_.altitude.meters() * 1000);
